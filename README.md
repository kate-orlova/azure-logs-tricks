...
* **requests** - calculate the total number of different or specific requests count and with average duration within a custom time range or for the last 24 hours by default;
